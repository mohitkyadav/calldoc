# Generated by Django 2.0.5 on 2018-07-27 11:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hospital', '0015_auto_20180727_1642'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='hospital',
            name='email',
            field=models.EmailField(blank=True, help_text='Please enter valid email address, it will be used for verification.', max_length=254),
        ),
        migrations.AlterField(
            model_name='hospital',
            name='phone_number',
